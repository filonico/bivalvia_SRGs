...
foxTree_data <- read.tree(text = "(Fox-M,((Fox-O,Fox-P),(Fox-J2/3,(((Fox-OG13/NA,Fox-N2/3),(Fox-OG16/NA,Fox-N1/4)),((Fox-K,Fox-J1),((Fox-Q2b,(Fox-Q2a,Fox-Q2c)),(Fox-G,(Fox-L2,((Fox-L1,Fox-C),((Fox-F,Fox-H),((Fox-E,Fox-D),(Fox-AB,(Fox-B,Fox-A)))))))))))));") %>%
  ape::drop.tip("foxK")
...
compute_occurrenceMatrix <- function(possvm_orthology_file, species_order) {
  ...
  names(gene_occurrence_filter) <- sub("fox_OG15:NA", "Fox-Q2b", colnames(gene_occurrence_filter))
  names(gene_occurrence_filter) <- sub("fox_OG28:NA", "Fox-Q2c", colnames(gene_occurrence_filter))
  ...
  names(gene_occurrence_filter) <- sub("foxQ2", "Fox-Q2a", colnames(gene_occurrence_filter))
