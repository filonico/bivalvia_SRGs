...
plot.tree <- function(input_filename, output_filename, output_height, output_width) {
  ...
  tree$tip.label <- ifelse(grepl("Hsap|Mmus|Emax|Oana", tree$tip.label),
