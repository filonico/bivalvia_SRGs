...
python3 scripts/01_download_genomes_with_datasets.py -i 00_input/drosophila_genome_toDownload.tsv -spID -d compiled_softwares/datasets -f cds,protein,gff3 -o 01_datasets
...
# figure 4B: diversity
mkdir 12_distribution_divergence/02_plot_diversity/
