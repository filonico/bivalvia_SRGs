...
species_fullNames <- as.factor(c("H. sapiens", "D. melanogaster", "C. elegans",
                                 ...
                                 "M. margaritifera*", "P. streckersoni*", "M. nervosa*", "C. plicata (tr)*", "H. bialata*", "L. orbiculatus (tr)*", "T. squamosa (tr)*", "P. generosa (tr)*", "S. constricta*", "S. grandis* (tr)", "P. coreanum (tr)*", "D. polymorpha*", "M. arenaria*", "M. chinensis (tr)*", "C. fluminea* (tr)", "P. okutanii (tr)*", "A. marissinica*", "C. sinensis*", "M. mercenaria*", "R. philippinarum*", "R. decussatus (tr)*", "T. granosa*", "S. broughtonii*", "P. yessoensis*", "P. maximus*", "A. purpuratus*", "A. irradians*", "P. purpuratus (tr)", "M. philippinarum", "M. modiolus (tr)*", "P. viridis*", "M. californianus", "M. coroscus", "M. edulis*", "M. galloprovincialis*", "P. margaritifera (tr)*", "A. pectinata (tr)*", "S. glomerata*", "O. edulis", "C. virginica*", "C. ariakensis", "C. gigas*", "C. angulata"))
