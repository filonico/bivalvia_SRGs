...
for i in 07_orthofinder/Results_splitted_hogs/Resolved_Gene_Trees/*txt; do
	...
	python3 compiled_softwares/disco.py -i $i -o "$OUTPUT_FILE" -d "_" -m 16 -v --keep-labels > 08_orthogroup_decomposition_alignment/"$OG"_disco_decomposed.log 2> /dev/null
